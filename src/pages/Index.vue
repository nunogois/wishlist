<template>
  <q-page class="flex flex-center">
    ...
    <draggable tag="q-list" :options="{delay:1000, delayOnTouchOnly:false}" :list="items" :component-data="{attrs: {noBorder: true }}" class="wishlist" v-if="items.length" @change="save_items">
